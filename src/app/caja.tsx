...
function textoResumen(r: ResumenDia): string {
  const lineas = [
    `Cierre de caja ${fechaLegible(r.fecha)}`,
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitulo}>Cierre de caja</Text>
        <Pressable
            ...
            {data.mediosPago.length === 0 ? (
              <View style={styles.card}>
                <Text style={styles.vacio}>
                  Sin pagos registrados en esta fecha. Registra el medio de pago al cobrar para verlo aquí.
                </Text>
              </View>
            ) : (
              <View style={styles.card}>
